...
class Form extends Component {
  ...
  componentWillMount() {
    let formRef = firebaseConf.database().ref('form').orderByKey().limitToLast(1);
          ...
          <div className='row'>
            <div className='col-sm-4'>
              ...
              <form onSubmit={this.sendMessage.bind(this)} ref='contactForm' >
                ...
                <div className='form-group'>
                  <label htmlFor='city'>Sports</label>
                  <select className='form-control' id='city' ref={city => this.inputCity = city}>
                    <option value='México'>Football</option>
                    <option value='Guadalajara'>Cricket</option>
                    <option value='Monterrey'>Hockey</option>
                    <option value='Monterrey'>Badminton</option>
                    <option value='Monterrey'>Lawn Tennis</option>
                    <option value='Monterrey'>BasketBall</option>
                    <option value='Monterrey'>Vollyball</option>
                  </select>
                </div>
